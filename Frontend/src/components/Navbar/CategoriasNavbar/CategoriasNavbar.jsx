    ...
    return(
        <>
            <ul className="navbar-nav me-auto">
                ...
                <Link className="nav-link homecito" style={{ color: misColores.color, backgroundColor: misColores.backgroundColor }} to={('/home')}>Inicio</Link>
                ...
                <Link className="nav-link homecito" style={{ color: misColores.color, backgroundColor: misColores.backgroundColor }} to={('/metas')}>Metas</Link>
